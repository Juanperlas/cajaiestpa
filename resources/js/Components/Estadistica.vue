        ...
        >
            ...
            >
                ...
                >
                    ...
                    TESORERÍA<slot name="oficina"></slot
                    ><span class="text-indigo-400">.</span>
                </h1>
                ...
                >
                    <div>
                        <img
                            class="rounded-full w-20 h-20 relative object-cover col-auto"
                ...
                <div id="menu" class="flex flex-col space-y-2 my-5">
                    ...
                    <Link
                        :href="route('registro.all')"
                        :active="route().current('registro.all')"
                        class="hover:bg-slate-200 transition duration-150 ease-linear rounded-lg py-3 px-2 group"
                    >
                        <div
                            class="flex flex-col space-y-2 md:flex-row md:space-y-0 space-x-2 items-center"
                    ...
                    <Link
                        :href="route('registro.reporte')"
                        :active="route().current('registro.reporte')"
                        class="hover:bg-slate-200 transition duration-150 ease-linear rounded-lg py-3 px-2 group"
                    >
                        <div
            ...
            >
                <div id="24h">
                    ...
                    <div
                        id="stats"
                        class="grid gird-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6"
                    >
                        <div
                            ...
                            <div class="flex flex-row items-center p-4">
                                ...
                                <div class="p-2">
                                    ...
                                    <p class="text-black font-medium">
                                        Total:
                                        <slot name="pagoTotalHoy"></slot>
                                    </p>
                                    <p class="text-black text-sm font-bold">
                                        Último:
                                        <slot name="pagoUltimoHoy"></slot>
                                    </p>
                                </div>
                            </div>
                        ...
                        >
                            <div class="flex flex-row items-center p-4">
                                ...
                                <div class="p-2">
                                    ...
                                    <p class="text-black font-medium">
                                        Total:
                                        <slot name="pagosTotalesTotal"></slot>
                                    </p>
                                    <p class="text-black text-sm font-bold">
                                        Último:
                                        <slot name="pagosTotalesUltimo"></slot>
                                    </p>
                                </div>
                            </div>
                            <div class="border-t border-black/20 p-4">
